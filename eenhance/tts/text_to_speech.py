...
class TextToSpeech:
    ...
    def _setup_directories(self) -> None:
        ...
        output_directories_transcripts = os.path.join(
            base_dir, self.output_directories.get("transcripts")
        )
        output_directories_audio = os.path.join(
            base_dir, self.output_directories.get("audio")
        )
        ...
        for dir_path in [
            output_directories_transcripts,
            output_directories_audio,
            self.temp_audio_dir,
        ]:
...
def main(seed: int = 42) -> None:
    ...
    try:
        ...
        with open(
            "tests/data/transcripts/transcript_336aa9f955cd4019bc1287379a5a2820.txt",
            "r",
        ) as file:
